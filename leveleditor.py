...
pygame.display.set_caption('Running Out Of Time Level Editor')
...
villain_img = pygame.image.load('Images/villain.png')
...
exitsign_img = pygame.image.load('Images/exitsign.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.transform.scale(villain_img, (tile_size, int(tile_size * 0.75)))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size * 0.25)))
				if world_data[row][col] == 4:
					#horizontally moving platform
					img = pygame.transform.scale(cloud_img, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size))
				...
				if world_data[row][col] == 8:
					#exit sign
					img = pygame.transform.scale(sign_img, (tile_size, int(tile_size * 1.5)))
					screen.blit(img, (col * tile_size, row * tile_size - (tile_size // 2)))
...
while run:
	...
	draw_text('Running out of time', font, white, tile_size, screen_height - 40)
